...
const cameraPositions = [
    // { position: new THREE.Vector3(34,5, 5.5, 18), lookAt: new THREE.Vector3(1,56, 4, -0,77) },
    // { position: new THREE.Vector3(1.4, 3.61, 2.87), lookAt: new THREE.Vector3(0.38, 2, 0.87) },
    // { position: new THREE.Vector3(-1.96, 2, 1.55), lookAt: new THREE.Vector3(0, 2.13, 1) },
    ...
    // { position: new THREE.Vector3(0.34, 2.75, -0.79), lookAt: new THREE.Vector3(-0.03, 2.2, 1.02) }
